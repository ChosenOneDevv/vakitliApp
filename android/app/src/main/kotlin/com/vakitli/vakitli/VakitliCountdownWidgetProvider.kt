...
/** Sonraki vakte kalan süreyi büyük gösteren geri sayım widget'ı. */
class VakitliCountdownWidgetProvider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            val views = RemoteViews(context.packageName, R.layout.vakitli_countdown_widget).apply {
                setTextViewText(
                    R.id.tv_prayer,
